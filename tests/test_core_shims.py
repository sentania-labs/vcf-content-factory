...
WRAPPERS = [
    ...
    ("vcfcf_extractor.extractor", "vcfcf_core.extractor.extractor",
     ...
     ("_collect_enablement_entries", "_dashboards_from_export_zip", "_info", "_parse_view_xml",
      "_resource_kinds_from_formula", "_rewrite_formula", "_safe_filename",
      "_supermetrics_from_export_zip", "_warn", "_write_dashboard_yaml", "_write_manifest",
      "_write_sm_yaml", "_write_view_yaml"),
     ("_SM_UUID_TOKEN_RE", "_content_xml_from_export_zip", "_parse_view_def_element", "_parse_time_window", "_parse_controls_columns",
