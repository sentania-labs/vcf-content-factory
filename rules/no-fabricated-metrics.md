...
Ground all metric and attribute references in `ops-recon` results, `docs/`, or OpenAPI specs. If a metric or attribute key doesn't appear in those sources, it doesn't exist.
