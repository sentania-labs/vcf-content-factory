...
Report definitions cannot be removed via the API and must be deleted
manually through the VCF Ops UI (Administration > Content > Reports).
...
[sentania/vcf-operations-content-generator](https://github.com/sentania/vcf-operations-content-generator)
