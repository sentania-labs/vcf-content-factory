...
the `src/vcfcf_managementpacks/installer.py` source, and the three
...
`src/vcfcf_managementpacks/installer.py` implements:
...
## Implications for `src/vcfcf_managementpacks/installer.py` if hypothesis 3 is confirmed
...
`src/vcfcf_managementpacks/installer.py`) and grepped for the
...
### Implications for `src/vcfcf_managementpacks/installer.py`
...
- `src/vcfcf_managementpacks/installer.py` — current dual-session
  CLI implementation.
