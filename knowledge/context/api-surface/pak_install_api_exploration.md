...
passive finding in `knowledge/context/mpb/reference-mpb-research.md`. The install path
...
- `knowledge/context/mpb/reference-mpb-research.md` §"VCF Ops API Surface for
