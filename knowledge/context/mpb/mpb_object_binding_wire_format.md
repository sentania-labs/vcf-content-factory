...
(`src/vcfcf_managementpacks/render.py`, `render_export.py`) and
...
At `src/vcfcf_managementpacks/render.py:1302` (or whichever line the
...
`vcfcf_managementpacks` validate-time checks (added to whichever
...
`src/vcfcf_managementpacks/render.py` chained-secondary-metricSet
...
Implemented in `src/vcfcf_managementpacks/render.py` Case 2 (2026-05-07).
The renderer now:
