...
**Factory support**: `python3 -m vcfcf_managementpacks render-export <mp.yaml> --out <output.json>`
implemented in `src/vcfcf_managementpacks/render_export.py` (2026-04-18).
...
**Tooling fix location**: `src/vcfcf_managementpacks/render_export.py`.
