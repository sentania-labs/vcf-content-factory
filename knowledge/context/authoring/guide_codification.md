...
| Wire format detail (zip layout, JSON shape, header) | `context/wire_formats.md` (or the topical wire format file) AND the relevant `src/vcfcf_*/render.py` or `loader.py` if the renderer needs to emit it |
