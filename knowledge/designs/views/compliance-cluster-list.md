# [VCF Content Factory] Compliance Clusters

- **Type:** view (bundled in the compliance pak)
- **Slug:** compliance-cluster-list
- **Authored YAML:** content/sdk-adapters/compliance/views/compliance-cluster-list.yaml
- **Date:** 2026-09-23
...
Feeds vCenter & Networking W3. Spec: columns in the wireframe row W3. Keys are the adapter v3 build 60 key list
