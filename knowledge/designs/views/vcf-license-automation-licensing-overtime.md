# Automation Licensing by Month

- **Type:** view
- **Slug:** vcf-license-automation-licensing-overtime
- **Authored YAML:** views/vcf_license_automation_licensing_overtime.yaml
- **Date:** 2026-08-26
- **Status:** drafted
...
- Month-by-month Automation host and licensed-core counts, for widget W12.

## Spec

**Name:** `[VCF Content Factory] Automation Licensing by Month`. Source: `[VCF Consumption Overview v2] Automation Licensing Overtime`.
...
| 1 | Automation Host Count | `supermetric:"[VCF Content Factory] Automation Managed Host Count"`, CURRENT |
| 2 | Automation License Consumption | `supermetric:"[VCF Content Factory] Automation Licensed Cores"`, CURRENT |
