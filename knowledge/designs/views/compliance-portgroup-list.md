# [VCF Content Factory] Compliance Distributed Portgroups

- **Type:** view (bundled in the compliance pak)
- **Slug:** compliance-portgroup-list
- **Authored YAML:** content/sdk-adapters/compliance/views/compliance-portgroup-list.yaml
- **Date:** 2026-09-23
...
Feeds vCenter & Networking W5. Spec: columns in the wireframe row W5. Keys are the adapter v3 build 60 key list
