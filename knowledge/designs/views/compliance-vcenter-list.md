# [VCF Content Factory] Compliance vCenter Servers

- **Type:** view (bundled in the compliance pak)
- **Slug:** compliance-vcenter-list
- **Authored YAML:** content/sdk-adapters/compliance/views/compliance-vcenter-list.yaml
- **Date:** 2026-09-23
...
Feeds vCenter & Networking W2. Spec: columns in the wireframe row W2. Keys are the adapter v3 build 60 key list
