...
2. **deterministically re-fetchable** via a registry the bootstrap runs
   (`knowledge/context/reference_sources.md`, `knowledge/context/managed_paks.md`, or a
   successor registry).
...
ops-PM fresh-eyes review, `knowledge/context/reviews/pm-feedback-2026-06-29.md`,
