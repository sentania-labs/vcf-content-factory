...
def _generate_describe_xml(mp: ManagementPackDef) -> tuple:
    ...
    lines.append(
        '<!-- Generated by vcfcf_managementpacks builder.py -->'
    )
    lines.append(
    ...
    with zipfile.ZipFile(buf, "w", compression=zipfile.ZIP_DEFLATED) as zf:
        ...
        if _GENERIC_ADAPTER_JAR.exists():
            ...
            jar_bytes = (
                ...
                b"vcfcf_managementpacks/adapter_runtime/mpb_adapter3.jar\n"
            )
...
def build_pak(
    ...
    *,
    ...
    with zipfile.ZipFile(pak_path, "w", compression=zipfile.ZIP_DEFLATED) as zf:
        ...
        # Template files under vcfcf_managementpacks/templates/ are kept for
