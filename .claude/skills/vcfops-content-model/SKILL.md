...
- For rule grammar details, read `knowledge/context/wire-formats/customgroup_relationship_grammar.md`.
...
- `knowledge/context/authoring/uuids_and_cross_references.md` — Full cross-reference
