...
1. **Find the appliance install service** and verify (a) whether cert-validity is enforced and (b) whether zero-byte-cert paks have a defined acceptance policy.
